...
public class StringMockDemo {
	public static void main(String[] args) {
		...
		boolean b1 = (s == s1);// 5) equal(==) operator --here we checked the memory location of two different
								// strings and
		// if both have same memory location then o/p is true otherwise it is false.
		...
		boolean b2 = (s == s3); // here contain of both string is same but both point to different memory
								// location there fore o/p is false.
		...
		boolean blnk = s6.isBlank();// here we checked that given sting is blank or not.if space is also consider as
									// blank.
